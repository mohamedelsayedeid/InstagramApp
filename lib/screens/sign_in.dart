...
import 'package:instagram/screens/forgot_passowrd.dart';
                ...
                SingleChildScrollView(
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    ElevatedButton(
                      ...
                      await Authentication().signIn(email: emailController.text,
                        ...
                        if(!mounted)return;
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Responsive(myWebScreen: WebScreen(), myMobileScreen: MobileScreen())));
